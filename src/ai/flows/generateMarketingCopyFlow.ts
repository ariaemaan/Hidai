...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert marketing copywriter for EduAfghanX, an app where users earn rewards by learning about Afghan culture.
  ...
  3.  **Hashtags**: A set of relevant hashtags, including brand hashtags like #EduAfghanX, #AfghanQuest, and others relevant to the campaign.
