    ...
    return (
        div className="space-y-8">
            div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                div>
                    h1 className="text-3xl font-headline font-bold tracking-tight">Copy & Social Tradingh1>
            ...
            Card>
                 CardHeader>
                     CardTitle className="font-headline">Your Copy Trading PortfolioCardTitle>
                 ...
                 CardContent>
                    div className="overflow-x-auto">
                        Table>
                            TableHeader>
                                TableRow>
                                    TableHead>TraderTableHead>
                                    TableHead>Risk ScoreTableHead>
                                    TableHead className="text-right">My P&L (USD)TableHead>
                                    TableHead className="text-center">StatusTableHead>
                                    ...
                                    TableRow key={trader.id}>
                                        TableCell>
                                            div className="flex items-center gap-3">
                                                Avatar>
                                                    AvatarImage src={trader.avatarUrl} alt={trader.name} data-ai-hint="avatar trader"/>
                                        ...
                                        TableCell className="text-right">
                                            Button variant="outline" size="sm">Stop CopyingButton>
                                        TableCell>
                                    TableRow>
                                ))}
                            TableBody>
            ...
            div>
                h2 className="text-2xl font-headline font-bold tracking-tight mb-4">Top Master Tradersh2>
                                ...
                                div className="flex items-start justify-between gap-4">
                                    div className="flex items-center gap-4">
                                        Avatar className="h-16 w-16 border-2 border-primary">
                                            AvatarImage src={trader.avatarUrl} alt={trader.name} data-ai-hint="avatar trader profile"/>
                                            AvatarFallback>{trader.name.charAt(0)}AvatarFallback>
                                        Avatar>
                                        div>
                            ...
                            CardHeader>
                             CardContent className="flex-1 space-y-4">
                                div className="grid grid-cols-3 gap-4 text-center">
                                    ...
                                    div>
                                     div className="p-2 bg-muted rounded-md">
                                        p className="text-xs text-muted-foreground">Win Ratep>
                                        p className="font-bold text-lg">{trader.winRate}%p>
                                    div>
                                     div className="p-2 bg-muted rounded-md">
                                        p className="text-xs text-muted-foreground">Riskp>
