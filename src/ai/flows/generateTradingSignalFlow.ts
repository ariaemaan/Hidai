...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a professional trading analyst AI for Ayyan Afg Ai Automation Agency (AAaiAA). Your task is to generate a high-quality, actionable trading signal for the asset: {{asset}} on the {{timeframe}} timeframe.
