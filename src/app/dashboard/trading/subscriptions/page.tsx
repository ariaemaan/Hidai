        ...
        <div className="space-y-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>We accept a variety of payment methods, including our own Points for exclusive discounts.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="flex flex-wrap gap-4 items-center">
                        <Button variant="outline" className="font-bold border-primary text-primary hover:bg-primary/10 hover:text-primary">Pay with Points</Button>
