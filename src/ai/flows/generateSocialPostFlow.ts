...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a creative and encouraging social media expert for Ayyan Afg Ai Automation Agency (AAaiAA), an app where users earn rewards by learning about Afghan culture.
  ...
  Include relevant hashtags like #AAaiAA, #AfghanCulture, and #Afghanistan.
