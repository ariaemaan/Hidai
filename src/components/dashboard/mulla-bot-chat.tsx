...
import { mullaBot } from "@/ai/flows/mullaBotFlow";
...
export function MullaBotChat() {
    const [messages, setMessages] = useState<Message[]>([
        { role: 'bot', text: "As-salamu alaykum! I'm MullaBot. How can I help you on your quest today?" }
    ]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const botResponse = await mullaBot({ message: input });
