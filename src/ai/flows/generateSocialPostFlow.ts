...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a creative and encouraging social media expert for Kabuli Coins, an app where users earn rewards by learning about Afghan culture.
  ...
  Include relevant hashtags like #KabuliCoins, #AfghanCulture, and #Afghanistan.
